...
@interface GangSRSecurityPolicy : NSObject

/**
 A default `GangSRSecurityPolicy` implementation specifies socket security and
 validates the certificate chain.

 Use a subclass of `GangSRSecurityPolicy` for more fine grained customization.
 */
...
/**
 ...
 you're free to override it in a subclass. See `GangSRPinningSecurityPolicy.h` for
 an example.
