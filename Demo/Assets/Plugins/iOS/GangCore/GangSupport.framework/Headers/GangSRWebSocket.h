...
@class GangSRWebSocket;
@class GangSRSecurityPolicy;

/**
 Error domain used for errors reported by GangSRWebSocket.
 */
...
///--------------------------------------
#pragma mark - GangSRWebSocket
///--------------------------------------

/**
 A `GangSRWebSocket` object lets you connect, send and receive data to a remote Web Socket.
 */
@interface GangSRWebSocket : NSObject <NSStreamDelegate>
 ...
 */
- (instancetype)initWithURLRequest:(NSURLRequest *)request securityPolicy:(GangSRSecurityPolicy *)securityPolicy;
...
/**
 ...
 @param securityPolicy Policy object describing transport security behavior.
 */
- (instancetype)initWithURLRequest:(NSURLRequest *)request protocols:(nullable NSArray<NSString *> *)protocols securityPolicy:(GangSRSecurityPolicy *)securityPolicy NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @param securityPolicy Policy object describing transport security behavior.
 */
- (instancetype)initWithURL:(NSURL *)url securityPolicy:(GangSRSecurityPolicy *)securityPolicy;
...
/**
 ...
 An instance of `GangSRWebSocket` is intended for one-time-use only. This method should be called once and only once.
 */
- (void)open;
...
/**
 The `SRWebSocketDelegate` protocol describes the methods that `GangSRWebSocket` objects
...
/**
 ...
 @param webSocket An instance of `GangSRWebSocket` that received a message.
 @param message   Received message. Either a `String` or `NSData`.
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didReceiveMessage:(id)message;
 ...
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didReceiveMessageWithString:(NSString *)string;
 ...
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didReceiveMessageWithData:(NSData *)data;
...
/**
 ...
 @param webSocket An instance of `GangSRWebSocket` that was open.
 */
- (void)webSocketDidOpen:(GangSRWebSocket *)webSocket;

/**
 Called when a given web socket encountered an error.

 @param webSocket An instance of `GangSRWebSocket` that failed with an error.
 @param error     An instance of `NSError`.
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didFailWithError:(NSError *)error;

/**
 Called when a given web socket was closed.

 @param webSocket An instance of `GangSRWebSocket` that was closed.
 ...
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(nullable NSString *)reason wasClean:(BOOL)wasClean;

/**
 Called on receive of a ping message from the server.

 @param webSocket An instance of `GangSRWebSocket` that received a ping frame.
 @param data      Payload that was received or `nil` if there was no payload.
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didReceivePingWithData:(nullable NSData *)data;

/**
 Called when a pong data was received in response to ping.

 @param webSocket An instance of `GangSRWebSocket` that received a pong frame.
 @param pongData  Payload that was received or `nil` if there was no payload.
 */
- (void)webSocket:(GangSRWebSocket *)webSocket didReceivePong:(nullable NSData *)pongData;
...
/**
 ...
 @param webSocket An instance of `GangSRWebSocket` that received a text frame.

 @return `YES` if text frame should be converted to UTF-8 String, otherwise - `NO`. Default: `YES`.
 */
- (BOOL)webSocketShouldConvertTextFrameToString:(GangSRWebSocket *)webSocket NS_SWIFT_NAME(webSocketShouldConvertTextFrameToString(_:));
