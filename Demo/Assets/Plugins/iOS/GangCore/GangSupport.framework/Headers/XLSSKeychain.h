...
typedef enum {
	/** No error. */
	XLSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	XLSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	XLSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	XLSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	XLSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	XLSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	XLSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	XLSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	XLSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	XLSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	XLSSKeychainErrorFailedToDecode = errSecDecode
} XLSSKeychainErrorCode;

extern NSString *const kXLSSKeychainService;
