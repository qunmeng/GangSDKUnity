...
@interface NSURLRequest (GangSRWebSocket)

/**
 An array of pinned `SecCertificateRef` SSL certificates that `GangSRWebSocket` will use for validation.
 */
...
@interface NSMutableURLRequest (GangSRWebSocket)
