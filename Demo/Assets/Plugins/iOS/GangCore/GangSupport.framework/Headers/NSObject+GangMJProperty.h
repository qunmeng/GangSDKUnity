...
#import "GangMJExtensionConst.h"

@class GangMJProperty;
 ...
 */
typedef void (^MJPropertiesEnumeration)(GangMJProperty *property, BOOL *stop);
...
/** 用于过滤字典中的值 */
typedef id (^MJNewValueFromOldValue)(id object, id oldValue, GangMJProperty *property);

/**
 * 成员属性相关的扩展
 */
@interface NSObject (GangMJProperty)
#pragma mark - 遍历
/**
 *  遍历所有的成员
 */
...
+ (id)mj_getNewValueFromObject:(__unsafe_unretained id)object oldValue:(__unsafe_unretained id)oldValue property:(__unsafe_unretained GangMJProperty *)property;
...
+ (id)getNewValueFromObject:(__unsafe_unretained id)object oldValue:(__unsafe_unretained id)oldValue property:(__unsafe_unretained GangMJProperty *)property MJExtensionDeprecated("请在方法名前面加上mj_前缀，使用mj_***");
